...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ChessThing", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ChessThing", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "ChessThing";
		app.meta["name"] = "ChessThing";
		app.meta["packageName"] = "com.sample.chessthing";
